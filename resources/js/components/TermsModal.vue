<template>
    <div class="modal fade modal_terms" ref="modal_terms" id="modal_terms" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
export default {
    ...
    mounted() {
        const modalEl = this.$refs.modal_terms
