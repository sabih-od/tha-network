                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Closed User</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
...
{{--                                <a class="btn btn-primary pull-right addBtn" href="{{route('admin.add-closed-user')}}">Add Closed User</a>--}}
{{--                            </div>--}}
                            <div class="col-md-12">
