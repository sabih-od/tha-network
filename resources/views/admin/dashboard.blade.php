...
@section('section')
                            ...
                            <div class="inner">
                                ...
                                <a href="#" type="button" id="btn_company_profit_this_month" style="color: inherit;">
                                    <p>
                                        ...
                                        This Month:
                                        ${{ $total_payments_this_month - $total_admin_withdrawals_this_month }}
                                        {{--                                This Month: $100--}}
                                    </p>
                                </a>
                                <br/>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post"
                                  action="{{route('admin.cms.maintenance.banner')}}"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="checkbox"
                                                   @if(isset($maintenance_banner->is_active) && $maintenance_banner->is_active == 1) checked
                                                   @endif
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="banner_text"
                                                   value="{{$maintenance_banner->banner_text ?? ''}}" required>
                                        </div>
    ...
    <div class="modal fade" id="modal_rewards_this_month" tabindex="-1" role="dialog"
    ...
    <div class="modal fade" id="modal_rewards_this_year" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_payments_this_month" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_payments_this_year" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_gross_income_this_month" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_gross_income_this_year" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_company_profit_this_month" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_company_profit_this_year" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modal_add_withdrawal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{route('admin.admin_withdrawal.create')}}" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input class="form-control" id="amount" type="number" name="amount" min="0.00"
                                       value="0.00" step="0.01" placeholder="Amount" required>
                            </div>
                            <div class="form-group col-12">
                                <label for="date">Amount</label>
                                <input class="form-control" id="date" type="date" name="date" placeholder="Asd"
                                       required>
                            </div>
