                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="one-pane" role="tabpanel" aria-labelledby="one-tab">
                                <form action="">
                                    ...
                                    <button type="submit" class="themeBtn" onclick="window.location.href='index.php'">LOGIN</button>
                                </form>
                            </div>
                            <div class="tab-pane fade" id="two-pane" role="tabpanel" aria-labelledby="two-tab">
                                <form action="">
                                    ...
                                    <button type="submit" class="themeBtn" onclick="window.location.href='index.php'">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
