                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="one-pane" role="tabpanel" aria-labelledby="one-tab">
                                <form action="tha-network.php">
                                    ...
                                    <div class="getText">
                                        <a href="invitation-code.php"> <span>To get invitation code</span> Click Here
                                        </a>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="two-pane" role="tabpanel" aria-labelledby="two-tab">
                                <form action="home.php">
                                    ...
                                    <button type="submit" class="themeBtn" onclick="window.location.href='home.php'">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
